...
func (c *userClient) GetUserByName(ctx context.Context, in *GetUserByNameRequest, opts ...grpc.CallOption) (*GetUserByNameReply, error) {
...
func (UnimplementedUserServer) GetUserByName(context.Context, *GetUserByNameRequest) (*GetUserByNameReply, error) {
